...
public class ProductManagerTest {
    ...
    public void shouldSearchByBook () {
        ...
        Product[] actual = manager.searcyBy("HowTocook");
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void shouldSearchByBook2 () {
        ...
        Product[] actual = manager.searcyBy("SomeBodyGuy");
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void shouldSearchBySmart2 () {
        ...
        Product[] actual = manager.searcyBy("3110");
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void shouldSearchByNoExist () {
        ...
        Product[] expected = {};
        Product[] actual = manager.searcyBy("17842");
        Assertions.assertArrayEquals(expected, actual);
    }
}
